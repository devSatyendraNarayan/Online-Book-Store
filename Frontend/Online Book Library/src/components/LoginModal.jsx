...
function LoginModal() {
  ...
  return (
    <>
      <div>
        <button
          className="btn bg-violet-600 text-gray-50 hover:dark:bg-gray-50 dark:hover:text-violet-600 duration-300"
      ...
      >
        <form method="dialog" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 bg-violet-600">
              Let's go!
            </button>
          </div>
