  ...
  return (
    <>
      <div className=" h-screen flex items-center justify-center ">
        <div className=" modal-box max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 max-h-full">
          ...
          <div className="flex items-center pt-4 space-x-1">
            ...
            <p className="px-3 text-sm dark:text-gray-600">or register with</p>
            <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
          </div>
