...
function footer() {
  return (
	...
	<div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row dark:divide-gray-600 max-w-screen-2xl md:px-20 px-4">
		<ul className="self-center cursor-pointer py-6 space-y-4 text-center  sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
			<li className='  hover:text-violet-600'>Shop</li>
			<li className='hover:text-violet-600'>About</li>
			<li className='hover:text-violet-600'>Blog</li>
			<li className='hover:text-violet-600'>Pricing</li>
			<li className='hover:text-violet-600'>Contact</li>
		</ul>
